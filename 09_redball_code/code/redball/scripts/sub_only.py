...
class Follower:
	def __init__(self):
		...
		# subscribed Topic
		self.subscriber = rospy.Subscriber("/output/image_raw/compressed", CompressedImage, self.image_callback,  queue_size = 1)
